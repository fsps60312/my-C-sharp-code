...
namespace Image_Distorter
{
    unsafe static class Bitmap_Extensions
    {
        ...
        static Bitmap Resize_W(Bitmap bmp, int width)
        {
            ...
            bool nega = width < 0;
            if (nega) width *= -1;
            Bitmap ans = BITMAP.New(width, bmp.Height);
            BitmapData data_bmp = bmp.GetBitmapData();
        ...
        static Bitmap Resize_H(Bitmap bmp, int height)
        {
            ...
            bool nega = height < 0;
            if (nega) height *= -1;
            Bitmap ans = BITMAP.New(bmp.Width, height);
            BitmapData data_bmp = bmp.GetBitmapData();
            BitmapData data_ans = ans.GetBitmapData();
            byte* ptr_bmp = data_bmp.GetPointer();
            byte* ptr_ans = data_ans.GetPointer();
        ...
        public static Bitmap Resize_ReplaceTransparent(this Bitmap bmp, Size sz)
        {
            ...
            Bitmap ans = BITMAP.New(sz.Width, sz.Height, Color.FromArgb(0, 0, 0, 0));
            BitmapData data_bmp = bmp.GetBitmapData();
            BitmapData data_ans = ans.GetBitmapData();
            byte* ptr_bmp = data_bmp.GetPointer();
            byte* ptr_ans = data_ans.GetPointer();
        ...
        static Bitmap Skew_H(Bitmap bmp, double angle)
        {
            ...
            Bitmap ans = BITMAP.New((W + Math.Abs(H * sin)).Round(), (H * cos).Round());
            BitmapData data_bmp = bmp.GetBitmapData();
            BitmapData data_ans = ans.GetBitmapData();
            byte* ptr_bmp = data_bmp.GetPointer();
            byte* ptr_ans = data_ans.GetPointer();
        ...
        static Bitmap Skew_V(Bitmap bmp, double angle)
        {
            ...
            Bitmap ans = BITMAP.New((W * cos).Round(), (H + Math.Abs(W * sin)).Round());
            BitmapData data_bmp = bmp.GetBitmapData();
            BitmapData data_ans = ans.GetBitmapData();
            byte* ptr_bmp = data_bmp.GetPointer();
            byte* ptr_ans = data_ans.GetPointer();
        ...
        static Bitmap Translate_H(Bitmap bmp, double angle)
        {
            ...
            double sin = Math.Sin(angle), cos = Math.Cos(angle), tan = sin / cos;
            double W = bmp.Width, H = bmp.Height;
            Bitmap ans = BITMAP.New((W + Math.Abs(H * tan)).Round(), (int)H);
            BitmapData data_bmp = bmp.GetBitmapData();
            BitmapData data_ans = ans.GetBitmapData();
            byte* ptr_bmp = data_bmp.GetPointer();
            byte* ptr_ans = data_ans.GetPointer();
        ...
        static Bitmap Translate_V(Bitmap bmp, double angle)
        {
            ...
            double sin = Math.Sin(angle), cos = Math.Cos(angle), tan = sin / cos;
            double W = bmp.Width, H = bmp.Height;
            Bitmap ans = BITMAP.New((int)W, (H + Math.Abs(W * tan)).Round());
            BitmapData data_bmp = bmp.GetBitmapData();
            BitmapData data_ans = ans.GetBitmapData();
            byte* ptr_bmp = data_bmp.GetPointer();
            byte* ptr_ans = data_ans.GetPointer();
        ...
        public static Bitmap Rotate(this Bitmap bmp, double angle, ref PointD center)
        {
            ...
            Bitmap ans = BITMAP.New((bmp.Height * sin + bmp.Width * cos).Round(), (bmp.Height * cos + bmp.Width * sin).Round());
            BitmapData data_ans = ans.GetBitmapData();
            BitmapData data_bmp = bmp.GetBitmapData();
            byte* ptr_ans = data_ans.GetPointer();
            byte* ptr_bmp = data_bmp.GetPointer();
        ...
        {
            Bitmap ans = BITMAP.New(bmp.Height, bmp.Width);
            BitmapData data_bmp = bmp.GetBitmapData();
            BitmapData data_ans = ans.GetBitmapData();
            byte* ptr_bmp = data_bmp.GetPointer();
            byte* ptr_ans = data_ans.GetPointer();
        ...
        {
            Bitmap ans = BITMAP.New(bmp.Width, bmp.Height);
            BitmapData data_bmp = bmp.GetBitmapData();
            BitmapData data_ans = ans.GetBitmapData();
            byte* ptr_bmp = data_bmp.GetPointer();
            byte* ptr_ans = data_ans.GetPointer();
        ...
        static Bitmap Join_Up(this Bitmap bac, Bitmap bmp, int dis, ref PointD center)
        {
            ...
            Bitmap ans = BITMAP.New(w2 - w1, bac.Height + bmp.Height);
            BitmapData data_ans = ans.GetBitmapData();
            BitmapData data_bmp = bmp.GetBitmapData();
        ...
        static Bitmap Join_Left(this Bitmap bac, Bitmap bmp, int dis, ref PointD center)
        {
            ...
            Bitmap ans = BITMAP.New(bac.Width + bmp.Width, h2 - h1);
            BitmapData data_ans = ans.GetBitmapData();
            BitmapData data_bmp = bmp.GetBitmapData();
            BitmapData data_bac = bac.GetBitmapData();
            byte* ptr_ans = data_ans.GetPointer();
        ...
        public static Bitmap RemoveTransparentEdge(this Bitmap bmp)
        {
            ...
            Bitmap ans = BITMAP.New(right - left + 1, down - up + 1);
            BitmapData data_ans = ans.GetBitmapData();
            byte* ptr_ans = data_ans.GetPointer();
    ...
    unsafe static class BitmapData_Extensions
    {
        ...
        public static Bitmap SubBitmap(this BitmapData data_bmp, Rectangle r)
        {
            ...
            Bitmap ans = BITMAP.New(r.Width, r.Height);
            BitmapData data_ans = ans.GetBitmapData();
            byte* ptr_ans = data_ans.GetPointer();
            byte* ptr_bmp = data_bmp.GetPointer();
        ...
        public static Bitmap Resize(this BitmapData data_bmp,Size sz)
        {
            ...
            bool hnega = sz.Height < 0;
            if (hnega) sz.Height *= -1;
            Bitmap ans = BITMAP.New(sz.Width, sz.Height);
            BitmapData data_ans = ans.GetBitmapData();
            byte* ptr_bmp = data_bmp.GetPointer();
            byte* ptr_ans = data_ans.GetPointer();
        ...
        #endregion
        delegate double DistortGetRatioX(PointD p);
        public static Bitmap Distort(this BitmapData data_bac,PointD ul,PointD ur,PointD dl,PointD dr)
        {
            PointD dismin = new PointD(Math.Min(ul.X, dl.X), Math.Min(ul.Y, ur.Y));
            ul -= dismin; ur -= dismin; dl -= dismin; dr -= dismin;
            Bitmap ans = BITMAP.New(Math.Max(ur.X, dr.X).Round(), Math.Max(dl.Y, dr.Y).Round());
            BitmapData data_ans = ans.GetBitmapData();
            byte* ptr_bac = data_bac.GetPointer(), ptr_ans = data_ans.GetPointer();
            DistortGetRatioX getratiox = new DistortGetRatioX((PointD p) =>
            {

                double l = 0.0, r = 1.0, mid = 0.5;
                PointD lp = default(PointD);
                while(r-l>CONST.EPS)
                {
                    mid = 0.5 * (l + r);
                    lp = ul * mid + dl * (1.0 - mid);
                }
            });
            Parallel.For(0, data_ans.Height, h =>
            {
    ...
    unsafe static class BITMAP
    {
        ...
        public static Bitmap StringToBitmap(string s, Size sz, object color = null, Font font = null)
        {
            ...
            Bitmap bmp = New(sz, Color.FromArgb(0, 0, 0, 0));
        ...
        #endregion
        #region New
        public static Bitmap New(int width, int height, object color = null)
        {
            Bitmap ans = new Bitmap(width, height, PixelFormat.Format32bppArgb);
            if (color == null) return ans;
            Color c = (Color)color;
            BitmapData data_ans = ans.GetBitmapData();
            byte* ptr_ans = data_ans.GetPointer();
        ...
        public static Bitmap New(Size sz, object color = null) { return New(sz.Width, sz.Height, color); }
        public static Bitmap New(BitmapData data_bmp)
        {
            Bitmap ans = New(data_bmp.Width, data_bmp.Height);
            BitmapData data_ans = ans.GetBitmapData();
            byte* ptr_bmp = data_bmp.GetPointer();
            byte* ptr_ans = data_ans.GetPointer();
            Parallel.For(0, data_ans.Height, h =>
        ...
        public static Bitmap FromFile(string location)
        {
            ...
            Bitmap ans = bmp.Clone(new Rectangle(0, 0, bmp.Width, bmp.Height), PixelFormat.Format32bppArgb);
            bmp.Dispose();
            return ans;
        }
        #endregion
        ...
        public struct Shape
        {
            ...
            {
                Bitmap ans = BITMAP.New(width, height);
                BitmapData data_ans = ans.GetBitmapData();
            ...
            {
                Bitmap ans = BITMAP.New((r * 2.0).Round(), (r * 2.0).Round());
                BitmapData data_ans = ans.GetBitmapData();
