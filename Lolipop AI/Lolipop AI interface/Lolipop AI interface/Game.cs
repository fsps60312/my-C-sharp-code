...
namespace Lolipop_AI_interface
{
    class Game
    {
        ...
        public Game()
        {
            ...
            inputField.AddField("升力", liftForce.ToString()).TextChanged += (o, e) => { try { liftForce = double.Parse((o as MyTextBox).Text); } catch (Exception) { MessageBox.Show("格式不正確"); } };
        ...
        public void Update(bool keyState)
        {
            ...
            velocity += keyState ? liftForce : gravity;
            location += velocity;
